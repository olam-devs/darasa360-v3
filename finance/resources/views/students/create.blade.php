                    ...
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="student_reg_no" id="student_reg_no" required value="{{ old('student_reg_no') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="class" id="class" required
                                    ...
                                    <option value="Form 1" {{ old('class') == 'Form 1' ? 'selected' : '' }}>Form 1</option>
                                    <option value="Form 2" {{ old('class') == 'Form 2' ? 'selected' : '' }}>Form 2</option>
                                    <option value="Form 3" {{ old('class') == 'Form 3' ? 'selected' : '' }}>Form 3</option>
                                    <option value="Form 4" {{ old('class') == 'Form 4' ? 'selected' : '' }}>Form 4</option>

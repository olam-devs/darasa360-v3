    ...
    <nav class="sticky top-0 z-50 border-b border-blue-100/80 bg-white/95 shadow-sm backdrop-blur">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap items-center justify-end gap-2 text-sm sm:gap-4">
                <a href="{{ route('superadmin.owner.dashboard') }}" class="rounded-lg px-2 py-1 text-slate-600 hover:bg-blue-50 hover:text-blue-800 {{ request()->routeIs('superadmin.owner.*') ? 'bg-blue-100 font-semibold text-blue-800' : '' }}">Overview</a>

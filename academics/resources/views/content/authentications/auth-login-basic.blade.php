...
<head>
    ...
    <title>Login — Darasa Academics</title>
...
<div class="wrap">
    ...
    <div class="hero">
        ...
        <i class="fi fas fa-chalkboard-teacher"  style="font-size:18px;left:70%;bottom:-40px;animation-duration:11s;animation-delay:2s;"></i>
        ...
        <i class="fi fas fa-atom"                style="font-size:17px;left:62%;bottom:-40px;animation-duration:11.5s;animation-delay:2.5s;"></i>
        <i class="fi fas fa-globe-africa"        style="font-size:19px;left:30%;bottom:-40px;animation-duration:10.5s;animation-delay:3.5s;"></i>
        <i class="fi fas fa-calculator"          style="font-size:14px;left:78%;bottom:-40px;animation-duration:12.5s;animation-delay:0.5s;"></i>
        <i class="fi fas fa-music"               style="font-size:12px;left:90%;bottom:-40px;animation-duration:9s;animation-delay:6s;"></i>

        <!-- top brand -->
        <div class="hero-brand">
            <div class="hero-brand-name">Darasa Academics</div>
        ...
        <div class="hero-main">
            ...
            <div class="hero-desc">One platform to manage classes, attendance, exams, reports and school communication — built for Tanzanian schools.</div>
        </div>
    ...
    <div class="form-side">
        <div class="card">
            <div style="text-align:center;margin-bottom:24px;">
                <img src="{{ asset('assets/images/v1_logo.png') }}" alt="Darasa360" style="width:100px;height:100px;object-fit:contain;display:block;margin:0 auto 10px;">
            ...
            <div class="portal-sub">Sign in to your account</div>
            ...
            <form method="POST" action="{{ url('/login') }}">
                ...
                <div class="field">
                    ...
                    <input type="text"
                           ...
                           class="inp{{ $errors->has('registration_no') ? ' err' : '' }}">
                    @error('registration_no')<p class="err-msg">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="field">
                    ...
                    <div class="pwd-wrap">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePwd()">
                            <i id="eye-show" class="fas fa-eye" style="font-size:15px;"></i>
                            <i id="eye-hide" class="fas fa-eye-slash" style="font-size:15px;display:none;"></i>
                        </button>
                    </div>
...
<footer>
    <span>&copy; {{ date('Y') }} Darasa Academics. All rights reserved.</span>
...
function togglePwd() {
    ...
    document.getElementById('eye-show').style.display = i.type === 'text' ? 'none' : 'inline';
    document.getElementById('eye-hide').style.display = i.type === 'text' ? 'inline' : 'none';
}
</script>
</body>
</html>

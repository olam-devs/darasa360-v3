...
<div class="row">
  <div class="col-12">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('students.index') }}" class="mb-4" id="searchForm">
      <div class="row g-3">
        <div class="col-md-4">
    ...
    <!-- Excel Operations -->
    @if($isAdmin)
    <form method="POST" action="{{ route('students.import') }}" enctype="multipart/form-data" class="mb-4">
      @csrf
            ...
            @forelse($students as $student)
              <tr>
                ...
                <td>
                  ...
                  <form action="{{ route('students.delete', $student->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure to delete this student?');">
                    @csrf
                    @method('DELETE')
...
<script>
  ...
  document.querySelectorAll('.edit-student-btn').forEach(button => {
    button.addEventListener('click', () => {
      ...
      form.action =  `/owner/students/update/${id}`;
